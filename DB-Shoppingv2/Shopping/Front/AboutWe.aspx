...
<div class="container body-content">
    ...
    <!-- row 3 --> 
        <div class="ex2" style="border-style:solid; background-color:lightgray; border-width:0px;">
            ...
            <p class="ex1"  style="font-size:16pt;font-family:'DFKai-sb'; text-align:right">學生:曾栢林、余玟萱、陳玟瑗</p> 
            <p class="ex1"  style="font-size:16pt;font-family:'DFKai-sb'; text-align:right">指導老師:陳耀輝老師</p> 
        </div>
    </div>
</asp:Content>
