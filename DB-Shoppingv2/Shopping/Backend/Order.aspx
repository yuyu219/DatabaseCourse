<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="Shopping.Backend.Record" %>
...
<div class="container body-content">
    ...
    <div style="text-align:right; padding-top:10px">
        ...
        <p class="ex1"  style="font-size:30pt;font-family:'DFKai-sb'; text-align:center;" >——訂單資訊——</p>
        <div>
            <table width="100%"  style="font-size:20pt; font-family:'DFKai-sb'; text-align:center;" rules="rows" frame ="below" cellpadding="5">
                <tbody class="ex3">
                   <tr>
		            <td align="center"; width="15%">訂單編號</td>
		            <td align="center"; width="12.5%">商品編號</td>
                    <td align="center"; width="15%">顧客編號</td>
		            <td align="center"; width="10%">數量</td>
		            <td align="center"; width="12.5%">運送方式</td>
                    <td align="center"; width="35%">訂購時間</td>
	              </tr>
