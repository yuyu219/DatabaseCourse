<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Shopping.Backend.InputProduct" %>
...
<div class="container body-content">
    ...
    <div style="text-align:right; padding-top:10px">
        ...
        <p class="ex1"  style="font-size:30pt;font-family:'DFKai-sb'; text-align:center;" >——新增上架商品——</p>
        <div>
            ...
            <div style="text-align:center; padding-top:10px">
                <asp:Button ID="AddBtn" runat="server" Text="新增" onclick="AddBtn_Click" style="text-align:left" Width="54px" />
            </div>
        </div>
   </div>
</div>
